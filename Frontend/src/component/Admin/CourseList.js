            ...
            <div>
                {
                    filteredData.map(course => (
                        <div className='d-flex justify-content-center align-items-center flex-column mx-auto mt-2' style={{ width: "45rem", backgroundColor: "white" }} key={course.courseId}>
                            ...
                            {role === 'ROLE_ADMIN'
                                ...
                                </div> : <div className='text-center mb-2'><Button variant='success' onClick={() => navigate(`/course-enroll/${course.courseId}`)}>Enroll Course</Button></div>}
                        </div>
                    ))
                }
            </div>
